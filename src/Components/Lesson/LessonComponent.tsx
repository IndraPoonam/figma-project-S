        ...
        return (
            <Card style={{ maxWidth: 900, padding: '20px', position: 'relative' }}>
                <Grid container justifyContent="space-between" alignItems="center">
                    <Typography variant="h5">Lesson   {this.props.index +1}</Typography>
                ...
                <CardContent sx={{ display: 'flex', gap: '2rem' }}>
                    <Box sx={{ height: 'full', width: '45rem', borderRight: '2px solid gray', padding: '6px' }}>
                        ...
                        <Box sx={{ display: 'flex' }}>
                        <Grid container spacing={2} alignItems="center" style={{ margin: 'normal' }}>
                            <Grid item>
                                <CardMedia
                                    component="img"
                                    height="140"
                    ...
                    <Box>
                        ...
                        <Box sx={{ height: '54vh', width: 'full', border: '2px solid gray' }}>  <ThemeProvider theme={myTheme}>
