...
//                         return <Box>
//                         <Box key={index} mt={2}>
//                             <ThemeComponent index={index}   handleDeleteTheme={this.handleDeleteTheme} />
//                         </Box>
...
class CourseInformation extends Component<Props, CourseInformationState> {
    ...
    render() {
        ...
        const { handleAddData, AllDataTheme, handleAddLesson, handleDeleteTheme } = this.props;
                            ...
                            <Box key={index} mt={2}>
                                ...
                                {theme.LessonData && theme.LessonData.map((lesson, lessonIndex) => (
                                    <Box key={lessonIndex} mt={2}>
                                        <LessonComponent index={lessonIndex} />
                                    </Box>
                                ))}
                                <Stack direction="row" spacing={2} mt={2}>
