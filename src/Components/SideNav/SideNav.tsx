...
export default class SideNav extends Component<Props, SideNavC> {
  ...
  render() {
    ...
    return (
      <Box sx={{ p: 3, borderRight: '1px solid #ddd', width: '14vw', height: 'fit', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', backgroundColor: '#f7f7f7', boxShadow: '2px 0 5px rgba(0,0,0,0.1)' }}>
